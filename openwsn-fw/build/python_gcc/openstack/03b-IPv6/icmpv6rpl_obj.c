...
This was done on 2018-08-16 09:56:18.035557.
*/
...
void icmpv6rpl_init(OpenMote* self) {
 ...
 openrandom_getRandomizePeriod(self, (self->icmpv6rpl_vars).daoPeriod, NUM_CHANNELS*SLOTFRAME_LENGTH*SLOTDURATION),
        TIME_MS,
        TIMER_ONESHOT,
...
void icmpv6rpl_timer_DIO_task(OpenMote* self) {
    ...
    if( openrandom_get16b(self)<0xffff/(3*( neighbors_getNumNeighbors(self)+1))){
 sendDIO(self);
    }
}
